...
TASK_TYPE_MAPPING = {
    ...
    "PostgresOperator": snowflake_builder,
    "SQLExecuteQueryOperator": snowflake_builder,
    "PythonOperator (Postgres concurrency diagnostics)": snowflake_builder,
    "PythonOperator/SQLOperator (Postgres)": snowflake_builder,
